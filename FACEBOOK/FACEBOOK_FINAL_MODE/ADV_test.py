...
class eta:
    def __init__(self):
        ...
        self.epochs = [10]#[250, 500, 1000] # # of passes of SGD
        self.epsilon = [0.5, 1]
        self.alpha = [0.5, 1]
...
def master(D, expCounter, sideBilinear, weightClass, eta_Latent, eta_RowBias, eta_LatentScaler, eta_Bilinear, epochs, alpha, epsilon, testSet):
    ...
    exportObject = export(eta_Latent, eta_RowBias, eta_LatentScaler, eta_Bilinear, (epochs - 1), alpha, epsilon, UCon, ULatentScalerCon, UBiasCon, WBilinearCon, UAdv, ULatentScalerAdv, UBiasAdv, WBilinearAdv, x0HR, y0HR, xAHR, yAHR)
    f = open(expString, 'wb')
...
importFile = open("exportSet.txt", "rb")
